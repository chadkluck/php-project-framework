...
function foo() {
	/* do something custom */
	return getApp("foo")['too']; // we'll get the app variable foo and return an item in it's associative array
}
...
function bar() {
	$bar = getApp("bar"); // this creates a reference to the app variable "bar"

	$bar = "42"; // we change the app variable "bar" to "42" and it will change it app-wide

	return getApp("bar"); // we return the value of bar using the getApp function
}
